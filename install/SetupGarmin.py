...
# -*- coding: utf-8 -*-
#
# Mon script de post installation
#
# Syntax: # sudo ./postinstall.sh
#
...
_CONF_FILE = "https://github.com/xonel/Scripts/raw/master/SetupGarmin.cfg"
...
def main(argv):
    ...
    if (_UBUNTU_VERSION != "raring"):
        showexec ("Script only for Ubuntu 13.04", "tpassousprecise", exitonerror = 1)
